$( document ).ready(function() {
    ...
    // Mel's note: What filter does is loops through inventors and decides whether to keep or not
    ...
    // Better way to write, using a ternary operator ( which basically says "if a is true(?) then do this, otherwise(:)"  :
    ...
    // Have to do in the console on the page
